...
Z0 %>% group_by(age) %>% 
  summarise (eG = sum(price - cost)/ sum(price))
```
##### 購買機率與預期營收的分布
...
mm=c(0.1,0.2,0.16,0.12,0.08)  ###I1:a24,a29
bb=c(20,40,50,80,100)        ###I2:a34,a39
aa=c(30,60,100,150,200)      ###I3:a44,a49
