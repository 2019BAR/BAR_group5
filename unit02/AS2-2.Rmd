...
```{r}
plot(IBM$Date, IBM$StockPrice,type='l',col='orange'
     ,xlim=as.Date(c('1983-01-01','1983-12-31')), ylim=c(0,150))
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("1983-01-01","1983-04-01","1983-07-01","1983-10-01")),col='gray',lty=3)
...
```{r}
plot(IBM$Date, IBM$StockPrice, type='l', col='orange', 
     xlim=as.Date(c('1999-03-01','2001-03-01')), ylim=c(0,250))
lines(GE$Date, GE$StockPrice, type='l', col='cyan')
lines(BOE$Date, BOE$StockPrice, type='l', col='pink')
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("2000-03-01")),col='gray',lty=3)
#GE's Stock fell the most
```
...
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("1995-01-01","2000-01-01","2005-01-01")),col='gray',lty=3)
```
...
sapply(L, function(df){
  df$StockPrice[ 
    df$Date %in% as.Date(c("1997-09-01", "1997-11-01")) 
    ]})
```
