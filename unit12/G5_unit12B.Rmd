...
```{r}
# A1:將風險成本(FN)由 100 降低至 50時，可以產生「全不做」比「全做」還要好的狀況
# A2:當我是一家保險公司時，遇到小感冒的病人，會採取「全不做」的策略
# 因為此類客戶只是遇到感冒醫療成本會小於投保成本，所以大家乾脆去掛號還比交保費便宜，所以沒有必要去製作此類保單
```
> 有五種成本分別為`$5, $10, $15, $20, $30`的介入方法，它們分別可以將風險成本從`$100`降低到`$70, $60, $50, $40, $25` ...<br>
【H】 它們的最佳期望報酬分別是多少？<br>
